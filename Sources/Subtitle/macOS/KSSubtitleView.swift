...
//        localIconView.setBackgroundImage(image(named: "ic_subtitle_local"), for: .normal)
//        localIconView.setBackgroundImage(image(named: "ic_subtitle_selected"), for: .selected)
...
//        checkView.image = image(named: "ic_check")
...
public class KSSubtitleView: UIControl, SubtitleViewProtocol {
    ...
    private var closeInfo = URLSubtitleInfo(subtitleID: "", name: "不显示字幕")
