...
install_xcframework "${PODS_ROOT}/../../Sources/libavcodec.xcframework" "libavcodec" "framework" "ios-x86_64-maccatalyst" "ios-x86_64-simulator" "ios-arm64"
install_xcframework "${PODS_ROOT}/../../Sources/libavformat.xcframework" "libavformat" "framework" "ios-x86_64-maccatalyst" "ios-arm64" "ios-x86_64-simulator"
install_xcframework "${PODS_ROOT}/../../Sources/libavutil.xcframework" "libavutil" "framework" "ios-arm64" "ios-x86_64-simulator" "ios-x86_64-maccatalyst"
install_xcframework "${PODS_ROOT}/../../Sources/libswresample.xcframework" "libswresample" "framework" "ios-arm64" "ios-x86_64-simulator" "ios-x86_64-maccatalyst"
install_xcframework "${PODS_ROOT}/../../Sources/libswscale.xcframework" "libswscale" "framework" "ios-x86_64-maccatalyst" "ios-arm64" "ios-x86_64-simulator"
