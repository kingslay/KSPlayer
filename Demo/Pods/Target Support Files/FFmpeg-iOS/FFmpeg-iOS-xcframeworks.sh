...
install_xcframework "${PODS_ROOT}/../../Sources/Libavcodec.xcframework" "Libavcodec" "framework" "ios-arm64_x86_64-simulator" "ios-x86_64-maccatalyst" "ios-arm64"
install_xcframework "${PODS_ROOT}/../../Sources/Libavformat.xcframework" "Libavformat" "framework" "ios-x86_64-maccatalyst" "ios-arm64" "ios-arm64_x86_64-simulator"
install_xcframework "${PODS_ROOT}/../../Sources/Libavutil.xcframework" "Libavutil" "framework" "ios-arm64_x86_64-simulator" "ios-x86_64-maccatalyst" "ios-arm64"
install_xcframework "${PODS_ROOT}/../../Sources/Libswresample.xcframework" "Libswresample" "framework" "ios-x86_64-maccatalyst" "ios-arm64" "ios-arm64_x86_64-simulator"
install_xcframework "${PODS_ROOT}/../../Sources/Libswscale.xcframework" "Libswscale" "framework" "ios-arm64_x86_64-simulator" "ios-arm64" "ios-x86_64-maccatalyst"
