...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/../../FFmpeg/FFmpeg.xcframework" "" "false" "ios-arm64/FFmpeg.framework" "ios-x86_64-maccatalyst/FFmpeg.framework" "ios-x86_64-simulator/FFmpeg.framework"
