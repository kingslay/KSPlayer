...
install_xcframework "${PODS_ROOT}/../../../FFmpegKit/Sources/Libavcodec.xcframework" "FFmpeg/FFmpeg" "framework" "macos-arm64_x86_64"
install_xcframework "${PODS_ROOT}/../../../FFmpegKit/Sources/Libavfilter.xcframework" "FFmpeg/FFmpeg" "framework" "macos-arm64_x86_64"
install_xcframework "${PODS_ROOT}/../../../FFmpegKit/Sources/Libavformat.xcframework" "FFmpeg/FFmpeg" "framework" "macos-arm64_x86_64"
install_xcframework "${PODS_ROOT}/../../../FFmpegKit/Sources/Libavutil.xcframework" "FFmpeg/FFmpeg" "framework" "macos-arm64_x86_64"
install_xcframework "${PODS_ROOT}/../../../FFmpegKit/Sources/Libswresample.xcframework" "FFmpeg/FFmpeg" "framework" "macos-arm64_x86_64"
install_xcframework "${PODS_ROOT}/../../../FFmpegKit/Sources/Libswscale.xcframework" "FFmpeg/FFmpeg" "framework" "macos-arm64_x86_64"
