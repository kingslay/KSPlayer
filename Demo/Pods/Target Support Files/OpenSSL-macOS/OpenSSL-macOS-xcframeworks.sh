...
install_xcframework "${PODS_ROOT}/../../FFmpegKit/Sources/Libssl.xcframework" "OpenSSL/OpenSSL" "framework" "macos-arm64_x86_64"
install_xcframework "${PODS_ROOT}/../../FFmpegKit/Sources/Libcrypto.xcframework" "OpenSSL/OpenSSL" "framework" "macos-arm64_x86_64"
