...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/../../Sources/FFmpeg.xcframework" "" "false" "ios-x86_64-simulator/FFmpeg.framework" "ios-arm64/FFmpeg.framework" "ios-x86_64-maccatalyst/FFmpeg.framework"
